# MakeInstallerNSIS.cmake  --  genera el instalador .exe de vpp con NSIS.
#
# Se ejecuta en modo script:
#   cmake -DBUILD_DIR=<build> -P cmake/MakeInstallerNSIS.cmake
#
# Si makensis no esta en el sistema, descarga la distribucion portable de NSIS
# (2.3 MB, hash fijado) en <build>/_nsis y la usa: el usuario NO tiene que
# instalar nada a mano.  Despues invoca cpack -G NSIS con makensis en el PATH.
#
# Origen: este script es el mismo que usa el repo VestaVM (cmake/), copiado aqui
# porque el preprocesador es un submodulo independiente y debe poder generar su
# instalador sin el arbol del proyecto padre.
...
#
# La carpeta contenedora (vpp-<ver>-<plataforma>/) se desactiva SOLO para el
# NSIS en cmake/VppCPackProjectConfig.cmake (CPACK_PROJECT_CONFIG_FILE), para
# que el .exe instale en `$PROGRAMFILES64pp\` y no en el subdir anidado
# `...pppp-<ver>-win64\`.
